...
const DEFAULT_PROJECTS = [
  { title: 'Portfolio Website', description: 'This site — a modular React + TypeScript component system with a refined retro-futuristic aesthetic. Built as a reusable framework.', tags: ['React', 'TypeScript', 'CSS'], liveHref: 'https://noahdean.dev', repoHref: 'https://github.com/Otternonsense1218/noah-portfolio' },
